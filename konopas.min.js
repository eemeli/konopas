...
function(e){return 1===e?"one":"other"};var t=
function(e){if(!e)throw new Error("MessageFormat: No data passed to function.")},n=
function(e,t,n){if(isNaN(e[t]))throw new Error("MessageFormat: `"+t+"` isnt a number.");return e[t]-(n||0)},r=
function(e,n){return t(e),e[n]},i=
function(n,r,i,a,o){return t(n),n[r]in o?o[n[r]]:(r=e.locale[a](n[r]-i),r in o?o[r]:o.other)},a=
function(e,n,r){return t(e),e[n]in r?r[e[n]]:r.other};window.i18n.en={weekday_n:
...
function(e){return r(e,"T")+" "+i(e,"T_UNIT",0,"en",{0:"seconds",1:"minutes",2:"hours",3:"days",4:"weeks",5:"months",6:"years",other:"???"})+" "+a(e,"T_PAST",{"true":"ago",other:"from now"})},search_hint:
...
function(e){return"For example, you could try <b>"+r(e,"X")+"</b>"},part_filter:
function(e){return a(e,"T",{first:"All participants by first name:",last:"All participants by last name:",other:"All programme participants"})},no_ko_id:
...
function(e){return"Program id <b>"+r(e,"ID")+"</b> not found!"},next_ended:
function(){return"There are no more program items scheduled."},next_start:
function(e){return"The next program item starts in "+i(e,"H",0,"en",{0:"",one:"one hour and",other:n(e,"H")+" hours and"})+" "+i(e,"M",0,"en",{one:"one minute",other:n(e,"M")+" minutes"})+" after the set time."},star_export_this:
function(e){return'Your current selection is encoded in <a href="'+r(e,"THIS")+'" target="_blank">this page\'s URL</a>, which you may open elsewhere to share your selection.'},star_export_share:
function(e){return'For easier sharing, you can also generate a <a href="'+r(e,"SHORT")+'">shorter link</a> or a <a href="'+r(e,"QR")+'">QR code</a>.'},star_import_this:
function(e){return'Your previously selected items are shown with a highlighted interior, while those imported via <a href="'+r(e,"THIS")+'">this link</a> have a highlighted border.'},star_import_diff:
function(e){return"Your previous selection "+i(e,"PREV",0,"en",{0:"was empty",one:"had one item",other:"had "+n(e,"PREV")+" items"})+", and the imported selection has "+i(e,"NEW",0,"en",{0:"no new items",one:"one new item",other:n(e,"NEW")+" new items"})+i(e,"SAME",0,"en",{0:"",one:"and one which was already selected",other:"and "+n(e,"SAME")+" which were already selected"})+"."},star_import_bad:
function(e){return i(e,"BAD",0,"en",{0:"",one:"One of the imported items had an invalid ID.",other:n(e,"BAD")+" of the imported items had invalid IDs."})},star_set:
function(){return"Set my selection to the imported selection"},add_n:
function(e){return"add "+r(e,"N")},discard_n:
function(e){return"discard "+r(e,"N")},star_add:
function(e){return"Add the "+i(e,"N",0,"en",{one:"new item",other:n(e,"N")+" new items"})+" to my selection"},star_export_link:
function(e){return'<a href="'+r(e,"URL")+'">Export selection</a> ('+i(e,"N",0,"en",{one:"one item",other:n(e,"N")+" items"})+")"},star_hint:
...
function(e){return"Listing "+i(e,"N",0,"en",{one:"one item: "+r(e,"TITLE"),other:n(e,"N")+" items with id "+r(e,"ID")})},filter_sum:
function(e){return"Listing "+i(e,"N",0,"en",{one:"one "+r(e,"TAG")+" item",other:r(e,"ALL")+" "+n(e,"N")+" "+r(e,"TAG")+" items"})+" "+a(e,"GOT_DAY",{"true":"on "+r(e,"DAY"),other:""})+" "+a(e,"GOT_AREA",{"true":"in "+r(e,"AREA"),other:""})+" "+a(e,"GOT_Q",{"true":"matching the query "+r(e,"Q"),other:""})},server_cmd_fail:
function(e){return'The command "'+r(e,"CMD")+'" failed.'},show_comments:
function(e){return"Show "+i(e,"N",0,"en",{one:"one comment",other:n(e,"N")+" comments"})},post_author:
function(e){return r(e,"N")+" posted…"},ical_login:
...
function(e){return'To view your selection in your calendar app, you may also <br class="wide-only">'+r(e,"A_TAG")+"make it available</a> in iCal (.ics) calendar format"},login_why:
function(){return"Once you've verified your e-mail address, you'll be able to sync your data between different clients (including external calendars), as well as vote & comment on items. After signing in, no information will be transmitted to these external services."}}}(),Server.prototype.disconnect=
...
function(e,t){e instanceof Array&&(e=e.join(",")),_log('server add_prog "'+e+'" '+(t?"1":"0"));var n=this.prog_mtime();this.exec("prog"+(t?"?add=":"?rm=")+e+(n?"&t="+n:""))
},Server.prototype.set_prog=
